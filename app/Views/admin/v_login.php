                            ...
                            <div class="p-5">
                                ...
                                <form method="POST" action="<?php echo site_url('')?>">
                                    <div class="form-group mb-3">
                                        <input class="form-control" autocomplete="on" id="inputEmail" type="email" placeholder="Email" name="email" value="<?php if($session->getFlashdata('email')) {
                                            echo $session->getFlashdata('email');
                                        }?>" />
                                    </div>
                                    <div class="pass-group mb-3">
                                        <input class="form-control" autocomplete="off" id="inputPassword" type="password" placeholder="Password" name="password" />
                                    </div>
                                    <button class="btn btn-lg btn-block btn-primary" type="submit" name="submit">Login</button>
                                </form>
                                <div class="text-center">
                                    <p></p>
                                    <a class="btn btn-success mt-3" href="<?php echo site_url("userguide")?>">USER GUIDE</a>
                                </div>
                            </div>
                        </div>
                    </div>
