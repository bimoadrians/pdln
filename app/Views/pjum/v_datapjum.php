                                                ...
                                                <?php foreach ($pum as $p => $pu1) { ?>
                                                    <?php foreach ($uangMasuk as $tk => $uangm) { ?>
                                                        <?php foreach ($total as $tl => $tot1) { ?>
                                                            <?php foreach ($tukarKeluar as $tk3 => $tukar3) {
                                                                $biaya_tukar = implode("", $tukar3);
                                                                $bia_tukar = floatval($biaya_tukar);
                                                            ?>
                                                                <?php foreach ($tukarMasuk as $tukarm1) {
                                                                    $biayarm1 = implode("", $tukarm1);
                                                                    $biarm1 = floatval($biayarm1);
                                                                ?>
                                                                    <?php if ($pu1['id_valas'] == $uangm['id_valas'] && $uangm['id_valas'] == $tot1['id_valas']) {
                                                                        // $sisa = ($pu1['pum'] + $tukar['uangmasuk']) - $tot1['pengeluaran'];
                                                                        if(empty($bia_tukar) && empty($biarm1)){
                                                                            $sisa = $pu1['pum'] - $tot1['pengeluaran'];
                                                                        } else if(!empty($bia_tukar) && empty($biarm1)) {
                                                                            $sisa = $pu1['pum'] - $tot1['pengeluaran'] - $bia_tukar;
                                                                        } else if(empty($bia_tukar) && !empty($biarm1)) {
                                                                            $sisa = $pu1['pum'] - $tot1['pengeluaran'] + $biarm1;
                                                                        } else if(!empty($bia_tukar) && !empty($biarm1)) {
                                                                            $sisa = $pu1['pum'] - $tot1['pengeluaran'] - $bia_tukar + $biarm1;
                                                                        }
                                                                    ?>
                                                                ...
                                                                ?>
                                                                    <?php if ($pu3['id_valas'] == $uangm1['id_valas'] && $uangm1['id_valas'] == $tot2['id_valas']) {
                                                                        if(empty($bia_tukar) && empty($biarm1)){
                                                                            ...
                                                                            $uangkembali = $pu3['uang_kembali'] - ($pu3['pum'] - $tot2['pengeluaran'] - $bia_tukar);
                                                                        } else if(empty($bia_tukar) && !empty($biarm1)) {
                                                                            $uangkembali = $pu3['uang_kembali'] - ($pu3['pum'] - $tot2['pengeluaran'] + $biarm1);
                                                                        } else if(!empty($bia_tukar) && !empty($biarm1)) {
                                                                            $uangkembali = $pu3['uang_kembali'] - (($pu3['pum'] - $tot2['pengeluaran'] - $bia_tukar)+ $biarm1);
                                                                        }
                                                                    ?>
